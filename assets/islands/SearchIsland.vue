...
<template>
  <section
    class="plume-island space-y-1 border border-dashed border-neutral-300 px-3 py-2 text-sm"
    aria-label="Search"
  >
    <p class="font-medium tracking-tight">Search</p>
    <p class="font-mono text-xs text-neutral-500">{{ strunaSlug || "—" }}</p>
    <p class="text-neutral-500">Scaffold — quick search via /bff/search/quick.</p>
  </section>
</template>
